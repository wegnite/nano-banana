 ...
 * 
 * Problem: lucide-react doesn't include brand-specific icons (GitHub, Google)
 * Solution: Create custom SVG icons using the same design principles
 * 
 * These icons match the visual style of lucide-react icons
 */
...
/**
 * GitHub brand icon
 * Uses the official GitHub icon path for consistency
 */
...
/**
 * Google brand icon
 * Uses the official Google "G" logo for consistency
 */
...
/**
 * Gmail brand icon
 * Alternative email icon using Gmail branding
 */
...
/**
 * Discord brand icon
 * Uses the official Discord logo
 */
